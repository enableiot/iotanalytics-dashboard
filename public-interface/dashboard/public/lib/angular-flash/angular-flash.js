/**! 
 * @license angular-flash v0.1.14 (modified)
...
(function () {
    ...
    angular.module('angular-flash.service', [])
        .provider('flash', function () {
			...
			/* 
				modification: added class 'sendFront' to classnames, which are added to flash alerts
				when they are triggered. this new class manipulates visibility of alerts.
			*/
            this.errorClassnames = ['alert-error', 'sendFront'];
            this.warnClassnames = ['alert-warn', 'sendFront'];
            this.infoClassnames = ['alert-info', 'sendFront'];
            this.successClassnames = ['alert-success', 'sendFront'];
